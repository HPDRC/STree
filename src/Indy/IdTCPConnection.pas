...
type
  ...
  public
    ...
    procedure ReadBuffer(var ABuffer; const AByteCount: int64);
    ...
    procedure WriteStream(AStream: TStream; const AAll: Boolean = True;
     const AWriteByteCount: Boolean = False; const ASize: Int64 = 0); virtual;
...
procedure TIdTCPConnection.ReadBuffer(var ABuffer; const AByteCount: Int64);
begin
